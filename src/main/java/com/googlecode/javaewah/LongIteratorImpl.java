...
/**
 * The LongIteratorImpl is the 64 bit implementation of the LongIterator
 * interface, which efficiently returns the stream of longs represented by an
 * EWAHIterator.
 *
 * @author Gregory Ssi-Yan-Kai 
 */
final class LongIteratorImpl implements LongIterator {
    ...
    LongIteratorImpl(EWAHIterator ewahIter) {
