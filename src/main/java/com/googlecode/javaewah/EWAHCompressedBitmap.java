...
public final class EWAHCompressedBitmap implements Cloneable, Externalizable,
     ...
     * @since 0.4.0
     */
    public long andCardinality(final EWAHCompressedBitmap a) {
     ...
     * @since 0.4.0
     */
    public long andNotCardinality(final EWAHCompressedBitmap a) {
        final BitCounter counter = new BitCounter();
     ...
     * @since 0.4.0
     */
    public long orCardinality(final EWAHCompressedBitmap a) {
        final BitCounter counter = new BitCounter();
    ...
    public boolean get(final long i) {
        ...
        while (wordChecked <= wordi) {
            ...
            if (wordi < wordChecked + j.getNumberOfLiteralWords()) {
                final long w = j.getLiteralWordAt((int) (wordi - wordChecked));
                return (w & (1l << i)) != 0;
            }
     ...
     */
    private boolean set(long i, boolean value) {
    ...
    private void setInRunningLength(boolean value, long i, long nbits, int pos, long rl, boolean rb, long lw) {
        if(value != rb) {
    ...
    private void setInLiteralWords(boolean value, long i, long nbits, int pos, long rl, boolean rb, long lw) {
        int wordPosition = (int) ((i - nbits) / WORD_IN_BITS + 1);
        long mask = 1l << i % WORD_IN_BITS;
        if(value) {
     ...
     * @param i the index
     */
    private long distanceInWords(long i) {
     ...
     * @since 0.4.0
     */
    public long xorCardinality(final EWAHCompressedBitmap a) {
        final BitCounter counter = new BitCounter();
     ...
     * @since 0.4.3
     */
    public static long andCardinality(final EWAHCompressedBitmap... bitmaps) {
        if (bitmaps.length == 1)
     ...
     * @since 0.4.0
     */
    public static long orCardinality(final EWAHCompressedBitmap... bitmaps) {
        if (bitmaps.length == 1)
            return bitmaps[0].cardinality();
        final BitCounter counter = new BitCounter();
