...
/**
 * The ReverseIntIterator is the 64 bit implementation of the LongIterator
 ...
 */
final class ReverseLongIterator implements LongIterator {
    ...
    ReverseLongIterator(ReverseEWAHIterator ewahIter, long sizeInBits) {
