...
/**
 * The LongIteratorImpl32 is the 32 bit implementation of the LongIterator
 * interface, which efficiently returns the stream of longs represented by an
 * EWAHIterator32.
 *
 * @author Gregory Ssi-Yan-Kai
 */
final class LongIteratorImpl32 implements LongIterator {
    ...
    LongIteratorImpl32(EWAHIterator32 ewahIter) {
